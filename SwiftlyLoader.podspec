#
# Be sure to run `pod lib lint SwiftlyLoader.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftlyLoader.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'SwiftlyLoader/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SwiftlyLoader' => ['SwiftlyLoader/Assets/*.png']
  # }
